    ...
    <div class="container-principal">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="tab-vinculo-view-modulo" data-bs-toggle="tab" data-bs-target="#view-modulo" type="button" role="tab" aria-controls="view-modulo" aria-selected="true">View Módulo</button>
                </li>
            </ul>

        <div class="tab-content">
            <div class="tab-pane active" id="view-modulo" role="tabpanel" aria-labelledby="tab-vinculo-view-modulo" tabindex="0">
                <div class="container-tabela">
                    <table class="myTable-modulos table nowrap order-column table-hover text-left">
                        <thead class="">
                            <tr>
                                <th class="all">Nome</th>
                                <th class="all">Total views</th>
...
<script>
    ...
    function configTabActiveModulosTelas(tabActive) {
        ...
        if (tabActive == 'tab-vinculo-view-modulo') {
                    ...
                    layout: {
                        ...
                        top2End: {
                            buttons: [
                                ...
                                {
                                    text: '<span class="material-symbols-rounded icone">add</span>Vincular',
                                    className: 'btn btn-personalizado-tabela btn-cadastro btn-cadastro-modulos',
                                    action: function (e, dt, node, config, cb) {
                                        abrirModalCadastrar('include/mVincularViewModulo.php', '.modal-body-cadastrar', '#modal-cadastrar', 'modal-lg','Vincular view x módulo');
                                    }
                                },
                            ],
                        },
